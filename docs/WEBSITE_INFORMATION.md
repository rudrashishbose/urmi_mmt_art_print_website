...
MissMoodyTiger presents and sells small-run art prints. The experience includes product browsing, product details, size-specific prices, local-currency display, a client-side cart, wishlist affordances, terms, and a placeholder login screen.

## Pages

| Route | Purpose |
| --- | --- |
| `index.html` | Home, featured shop grid, studio notes, and about content. |
