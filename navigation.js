(() => {
  ...
  const active = page === 'products.html' || page === 'art-print.html' || page === 'gallery.html' || page === 'midnight-familiar.html' || page === 'shop.html'
    ? 'shop'
    : page === 'studio-admin.html' ? 'admin'
  ...
  if (footerLinks && page === 'index.html') {
    footerLinks.className = 'footer-content';
    footerLinks.innerHTML = '<div class="footer-column"><a href="#shop">shop</a><a href="contact.html">contact</a></div><div class="footer-column"><a href="terms.html">terms &amp; conditions</a></div><div class="footer-social" aria-label="Social channels"><a href="https://www.instagram.com/" target="_blank" rel="noopener" aria-label="Instagram">◎ instagram</a><a href="https://www.youtube.com/" target="_blank" rel="noopener" aria-label="YouTube">▶ youtube</a></div>';
  }
})();
